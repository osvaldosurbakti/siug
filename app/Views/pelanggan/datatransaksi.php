...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="perjanjiangadai">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Perjanjian Gadai</span></a>
            </li>
            <!-- Divider -->
            <hr class="sidebar-divider my-0">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="pelangganlelang">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Informasi Barang Lelang</span></a>
            </li>
            <!-- Divider -->
                        ...
                        <div class="col-lg-7 my-auto">
                            <div class="p-5">
                                <form class="user">
                                    ...
                                    <div class="form-group">
                                        <label for="nama">Jumlah Pinjaman Yang Perlu Dibayarkan</label>
                                        <input type="text" id="rupiah" name="rupiah" placeholder="Rp 0">
                                    </div>
                                    <label for="nama">Batas Akhir Pembayaran Pinjaman</label>
