...
$routes->get('/adminlelang/tambahbaranglelang', 'Adminlelang::create');
$routes->get('/adminlelang/edit/(:segment)', 'Adminlelang::edit/$1');
...
$routes->get('/adminlelang/updatebaranglelang', 'Adminlelang::updatebaranglelang');
$routes->post('/adminlelang/updatebaranglelang', 'Adminlelang::updatebaranglelang');
...
$routes->get('/adminlelang/edit/(:num)', 'Adminlelang::edit/$1');
